...
The \textit{standard deviation} of the mean of the 9 tournaments for each bot against rdeep is 0.02804758.
First of all, the learning bots performed worse than rdeep. The worst performer was, surprisingly, the stock ml bot. However, the results of the bots are relatively close, except for the ml\_minimal bot. 
