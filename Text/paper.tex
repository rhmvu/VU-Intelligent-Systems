...
To answer our research question, multiple Schnapsen tournaments were held. Each machine-learning bot played multiple 120 game tournaments against each individual non-learning bot. Each learning bot played 9 tournaments with 3 different models against each static bot.
The non-machine learning opponents were:
 \begin{itemize}
\item Bully
\item Rand
\item Rdeep
